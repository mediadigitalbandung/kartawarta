              ...
              <table className="w-full min-w-[640px]">
                <thead>
                  <tr className="border-b border-border bg-surface-secondary">
                    <th className="px-5 py-3.5 text-left text-sm font-medium text-txt-secondary">Waktu</th>
                    <th className="px-5 py-3.5 text-left text-sm font-medium text-txt-secondary">Pengguna</th>
                    <th className="px-5 py-3.5 text-left text-sm font-medium text-txt-secondary">Fitur</th>
                    <th className="px-5 py-3.5 text-right text-sm font-medium text-txt-secondary">Token</th>
                  ...
                  {logs.length === 0 ? (
                    ...
                    logs.map((log) => (
                      <tr key={log.id} className="border-b border-border last:border-0 hover:bg-surface-secondary/50 transition-colors">
                        <td className="px-5 py-4 text-sm text-txt-secondary whitespace-nowrap">{formatDate(log.createdAt)}</td>
                        ...
                        <td className="px-5 py-4 text-right text-sm font-medium text-txt-primary">{formatNumber(log.totalTokens)}</td>

    ...
    <div className="relative bg-surface border-b border-border overflow-hidden">
      <div className="flex items-center py-2 sm:py-2.5">
        ...
        <div className="shrink-0 flex items-center gap-1.5 px-3 sm:px-4 border-r border-border mr-2">
          ...
          <span className="text-[10px] sm:text-xs font-bold tracking-widest text-primary uppercase whitespace-nowrap">
            Trending
          </span>
        </div>
          ...
          >
            {looped.map((item, i) => (
              <Link
                ...
                onClick={onLinkClick}
                className="mx-6 sm:mx-10 inline-flex items-center gap-2 text-xs sm:text-sm font-medium text-txt-primary/75 transition-colors duration-200 hover:text-primary whitespace-nowrap"
              >
